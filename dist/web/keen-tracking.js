...
// Patch for RN
var isUnique = function isUnique(configObject, extendedEventsHash) {
...
function recordEvent(eventCollectionOrConfigObject, eventBody, callback) {
  ...
  if (unique) {
    return isUnique(configObject, extendedEventsHash).then(function (isUniqueResult) {
      if (!isUniqueResult) {
...
var _recordEventsReactNative = __webpack_require__(34);
...
(0, _extend2.default)(_index2.default.prototype, {
  recordEvent: _recordEventsReactNative.recordEvent,
  recordEvents: _recordEventsReactNative.recordEvents
});
